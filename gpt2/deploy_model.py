...
# 
from gpt2.deployment import Deployer
from gpt2.modeling import Transformer, ModelArgs
from gpt2.data import Dataset, Dataloader, Tokenizer, TokenizerArgs
from gpt2.utils.osutil import files_in_directory
from gpt2.utils.argparse_types import positive_integer, nonzero_integer, directory, filepath


class Specification:
    def __init__(self, args : argparse.Namespace):
        self.__dict__.update(args.__dict__)
        self.description='evaluating gpt2'
...
def deploy_gpt2_model(args : argparse.Namespace):
    specification = Specification(args)
    Deployer(specification).deploy(from_checkpoint=args.from_checkpoint)


def add_subparser(subparsers : argparse._SubParsersAction):
    parser = subparsers.add_parser('deploy', help='deploy and evaluate GPT-2 model')
    # corpus 
    ...
    group.add_argument('--n_layers', default=12, type=positive_integer,
                       help='number of transformer layers')
    group.add_argument('--dim', default=768, type=positive_integer,
                       help='dimension of representation in each layer')
    group.add_argument('--n_heads', default=12, type=positive_integer,
    ...
    group.add_argument('--batch_size', default=64, type=positive_integer,
    ...
    # set defaults 
    parser.set_defaults(func=deploy_gpt2_model)
