...
from gpt2.data import Tokenizer, TokenizerArgs
from gpt2.utils.argparse_types import positive_integer, probability, filepath


class Specification:
    def __init__(self, args : argparse.Namespace):
        self.__dict__.update(args.__dict__)
        self.description='generating sentences with gpt2'
...
def generate_with_gpt2_model(args : argparse.Namespace):
...
def add_subparser(subparsers : argparse._SubParsersAction):
    parser = subparsers.add_parser('generate', help='generate sentences with GPT-2 model')
    # corpus 
    ...
    # set defaults 
    parser.set_defaults(func=generate_with_gpt2_model)
