...
train_template = "python -m gpt2 train \
                     --train_corpus           /workspace/Datasets/WikiPedia/pretrain_data/train \
                     --eval_corpus            /workspace/Datasets/WikiPedia/pretrain_data/eval \
...
def main(args):
    ...
    plot_lin_least_squares(p_dim, p_core_dim, a, b, ymin, ymax, 'dim', 'core_dim')
    print()
